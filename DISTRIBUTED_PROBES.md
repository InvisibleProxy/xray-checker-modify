...
- наблюдение становится находкой только со второго совпадающего прохода. Локальная половина сравнения отстаёт на величину до `PROXY_CHECK_INTERVAL`, и это единственный дешёвый способ отсеять артефакт устаревания, не заставляя диагностический workflow дёргать availability loop.
