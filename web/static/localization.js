(function () {
  ...
  const ru = {
    ...
    "Watched like the deployment's own subscription.": "Наблюдается так же, как собственная подписка.",
    "Checked and alerted on as usual, but scheduled speed tests skip it.": "Проверяется и алертит как обычно, но плановый speedtest её пропускает.",
