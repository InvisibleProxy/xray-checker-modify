(function () {
  ...
  const ru = {
    "Total": "Всего", "Online": "Онлайн", "Offline": "Офлайн", "Maintenance": "Обслуживание", "Avg Latency": "Средняя задержка",
    ...
    "Dashboard": "Dashboard", "Nodes Overview": "Обзор нод", "Incidents": "Инциденты",
    "Speed History": "История speedtest", "Controls": "Управление", "Actions and settings": "Действия и настройки",
