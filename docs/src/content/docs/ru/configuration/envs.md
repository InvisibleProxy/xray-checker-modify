...
URL по умолчанию для приватных speed-test в админ-панели, расписании и проверках, запущенных из Telegram. URL можно переопределить в сохраненном расписании или ручном запуске.
