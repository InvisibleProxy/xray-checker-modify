...
- CLI: `--speed-test-url`
- Обязательно: Нет
- По умолчанию: `https://proof.ovh.net/files/10Mb.dat`

URL по умолчанию для приватных speed-test в админ-панели, расписании и проверках, запущенных из Telegram. URL можно переопределить в сохраненном расписании или ручном запуске. Если расписание уже сохранено с другим `Test URL`, сохраненное значение имеет приоритет над `SPEED_TEST_URL`.
